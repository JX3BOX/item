            ...
            <el-col :xs="24" :md="21">
                <el-row class="m-fields">
                    ...
                    <el-col :xs="12" :md="8" class="m-field">
                        ...
                        <span
                            class="u-value"
                            v-text="$options.filters.item_price(item.Price)"
                        ></span>
                    </el-col>
                    <el-col :xs="12" :md="8" class="m-field">
                    ...
                    <el-col :xs="12" :md="8" class="m-field">
                        ...
                        <span
                            class="u-value"
                            v-text="$options.filters.item_bind(item.BindType)"
                        ></span>
                    </el-col>
                    <el-col
                        :xs="12"
                        :md="8"
                        class="m-field"
                        v-if="item.Require1Type"
                    >
                        <label
                            class="u-title"
                            v-text="
                                $options.filters.item_require_1_type(
                                    item.Require1Type
                                ) + '：'
                            "
                        ></label>
                    ...
                    <el-col :xs="12" :md="8" class="m-field">
                        ...
                        <span
                            class="u-value"
                            v-text="
                                item.CanDestroy || item.CanDestroy === null
                                    ? '✔️'
                                    : '❌'
                            "
                        ></span>
                    ...
                    <el-col :xs="12" :md="8" class="m-field">
                        ...
                        <span
                            class="u-value"
                            v-text="$options.filters.item_quality(item.Quality)"
                            :style="{
                    ...
                    <el-col :xs="12" :md="8" class="m-field">
                        ...
                        <span
                            class="u-value"
                            v-text="
                                $options.filters.item_require_camp(
                                    item.RequireCamp
                                )
                            "
                        ></span>
