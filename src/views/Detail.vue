		...
		<div class="m-wiki-post-panel" v-if="wiki_post && wiki_post.post">
			<WikiPanel :wiki-post="wiki_post">
				...
				<template slot="body">
					...
					<Thx class="m-thx" :postId="id" postType="item" :postTitle="wiki_post.source.Name" :userId="author_id" :adminBoxcoinEnable="true" :userBoxcoinEnable="true" :authors="authors" mode="wiki" :key="'item-thx-' + id" :client="client" />
				</template>
			</WikiPanel>
