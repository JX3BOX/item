<template>
  <div class="m-item" v-if="item">
    <div class="item-detail">
      ...
      <!-- 最大拥有数 -->
      <div v-if="parseInt(item.MaxExistAmount) > 1" class="u-max-exist-amount" v-text="'最大拥有数：' + item.MaxExistAmount"></div>
      <!-- 物品类型文案 -->
      ...
      <!-- 最大耐久度 -->
      <div v-if="item.AucSubType>=1&&item.AucSubType<=3" class="u-max-durability" v-text="'最大耐久度' + item.MaxDurability"></div>
      <!-- 描述 -->
